/**
 * API endpoint to serve internal-average-traffic-priority.csv from S3
...
const S3_KEY = 'internal-average-traffic-priority.csv';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (error.name === 'NoSuchKey') {
      return res.status(404).json({ error: 'Priority data not found' });
    }
